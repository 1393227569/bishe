<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="专利编号" prop="zhuanlibianhao">
          <el-input v-model="ruleForm.zhuanlibianhao" 
              placeholder="专利编号" clearable  :readonly="ro.zhuanlibianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="专利编号" prop="zhuanlibianhao">
              <el-input v-model="ruleForm.zhuanlibianhao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="专利类型" prop="zhuanlileixing">
          <el-input v-model="ruleForm.zhuanlileixing" 
              placeholder="专利类型" clearable  :readonly="ro.zhuanlileixing"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="专利文件" prop="zhuanliwenjian">
          <file-upload
          tip="点击上传专利文件"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.zhuanliwenjian?ruleForm.zhuanliwenjian:''"
          @change="zhuanliwenjianUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.zhuanliwenjian" label="专利文件" prop="zhuanliwenjian">
            <el-button type="text" size="small" @click="download(ruleForm.zhuanliwenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="专利简介" prop="zhuanlijianjie">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="专利简介"
                  v-model="ruleForm.zhuanlijianjie" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhuanlijianjie" label="专利简介" prop="zhuanlijianjie">
                    <span>{{ruleForm.zhuanlijianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	zhuanlijianjie : false,
	zhuanliwenjian : false,
	gonghao : false,
	xingming : false,
	faburiqi : false,
      },
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhuanlileixing = true;
          ...
          if(o=='zhuanlijianjie'){
            this.ruleForm.zhuanlijianjie = obj[o];
	    this.ro.zhuanlijianjie = true;
            continue;
          }
          if(o=='zhuanliwenjian'){
            this.ruleForm.zhuanliwenjian = obj[o];
	    this.ro.zhuanliwenjian = true;
            continue;
          }
          if(o=='gonghao'){
    ...
    zhuanliwenjianUploadChange(fileUrls) {
	this.ruleForm.zhuanliwenjian = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
